...
CREATE TABLE Silabo (
  ...
  -- sil_sem INT   ,
  --sil_inst_eva varchar(100)  ,
  sil_per_aca varchar(20)  ,
  sil_fun varchar(100000)  ,
  sil_sum INT   ,
  sil_req_apro INT   ,
  PRIMARY KEY (sil_ide)
);
...
CREATE TABLE Estrategia_evaluacion (
  est_eva_ide INT NOT NULL AUTO_INCREMENT  ,
...
CREATE TABLE Curso (
  cur_sem INT NOT NULL AUTO_INCREMENT  ,
  cur_credi INT   ,
  cur_hor_teo INT   ,
  cur_hor_prac INT   ,
  cur_hor_lab INT   ,
...
CREATE TABLE Silabo_estrategia_aprendizaje (
  sil_est_apre_ide INT NOT NULL AUTO_INCREMENT  ,
  est_apre_ide INT   ,
  sil_ide INT   ,
...
CREATE TABLE Estrategia_aprendizaje (
  est_apre_ide INT NOT NULL AUTO_INCREMENT  ,
...
CREATE TABLE Resultado (
  res_ide INT NOT NULL AUTO_INCREMENT  ,
...
CREATE TABLE Resultado_silabo (
  res_sil_ide INT NOT NULL  AUTO_INCREMENT  ,
  res_ide INT   ,
  sil_ide INT   ,
...
DROP TABLE IF EXISTS CREATE TABLE Prerequisitos
;
